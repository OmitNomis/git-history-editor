  ...
  return (
    <Flex flexDir="column" gap={8} as={"section"}>
      <Box>
        ...
        <Text>Introducing GitRevise: Your Git History Sculptor!</Text>
      </Box>
      <Box>
        ...
        <Text>
          <strong>GitRevise</strong> is your reliable Git history editor, a tool
          designed to give your project's past a professional polish. No magic
          wands, just seamless Git history editing at your fingertips.
        </Text>
      </Box>
      <Box>
        <Heading mb={4} size="md">
        ...
        <Text>
          Why settle for a messy Git history when you can have a clean slate?
          GitRevise offers:
        </Text>
      </Box>
      <Box>
        <Text>
          - <strong>Precise Authorship Editing:</strong> Fix incorrect names and
          emails attached to commits without a hassle.
        </Text>
        <Text>
          - <strong>Clearer Commit Messages:</strong> Upgrade your commit
          messages for a more professional touch, enhancing project clarity.
        </Text>
        <Text>
          - <strong>Time Management:</strong> Adjust commit timestamps to align
          with your project's timeline, ensuring a coherent history.
        </Text>
      </Box>
      <Box>
        <Heading mb={4} size="md">
        ...
        <Text>
          Using GitRevise is as easy as pie. Execute a command in your project
          directory, paste your git log output, and you're set to refine your
          Git history.
        </Text>
      </Box>
      <Box>
        ...
        <Text color={"GrayText"} textAlign="center" mt={{ base: 5, sm: 0 }}>
          <i>
            (replace 100 with the maximum number of commits you want to import)
          </i>
        </Text>
      </Box>
      <Box as="form" onSubmit={handleFormSubmit} mt={4}>
        <Box mb={5}>
          ...
          <Text>
            ...
            to import a sample Git history.
          </Text>
        </Box>
